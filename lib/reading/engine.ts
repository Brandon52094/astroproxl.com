...
export function buildReadingPrompt(
  ...
  sections.push(
    ...
    "",
    "DEPTH STANDARD:",
    "This is a premium full reading, not a brief horoscope or summary.",
    "Develop the interpretation enough that the user understands not only what is active, but what it is likely to mean in lived experience.",
    "Aim for roughly 1,800-2,500 words when the supplied evidence supports that depth.",
    "Do not add filler, repeat conclusions, or inflate weak evidence merely to reach a length target.",
    "If the chart evidence is limited, be shorter rather than manufacturing substance.",
    "",
    ...
    "Develop what is changing, what appears to be building or resolving, and why it matters specifically to the user's question.",
    "When the evidence supports a concrete event, describe it concretely. When it supports only an activation, explain what is clearly indicated without pretending the manifestation is predetermined.",
    "",
    "PART 2 — WHY THIS IS ACTIVE NOW",
    "Explain the primary predictive evidence and how the techniques converge.",
    "Do not merely list placements or repeat Part 1 in different words.",
    "Explain what each major piece of evidence contributes to the interpretation and why the combination matters more than any single factor alone.",
    "Distinguish the primary signal from confirmation and background context.",
    "",
    "PART 2B — HOW IT IS MOST LIKELY TO SHOW UP",
    `Translate the astrology specifically into the ${topic.id} area.`,
    "Make this the most grounded and practically recognizable section of the reading.",
    "Describe the most likely real-world manifestation, including the circumstances, behaviors, decisions, opportunities, tensions, or interactions the user may actually recognize.",
    "Include both the constructive potential and the main complication, blind spot, or red flag when supported by the evidence.",
    "If more than one manifestation genuinely fits the same evidence, rank the possibilities rather than presenting all possibilities as equally likely.",
    ...
    "For each valid window, explain what is peaking, what the user may notice around it, and why that particular activation matters.",
    "Do not create additional dates simply to make this section longer.",
    "",
    "PART 4 — THE DIRECTIVE",
    "Give practical action tied directly to the reading evidence.",
    "Make the advice specific enough to act on rather than generic encouragement.",
    "Explain what to lean into, what to avoid, and what decision or behavior gives the user the strongest position under the current astrology.",
    "",
    "PART 5 — BOTTOM LINE",
    "Close with a concise synthesis of the central development.",
    "State what is most likely changing, the most important opportunity or caution, and the single thing the user should remember after leaving the reading.",
    "Do not introduce new predictions or evidence here.",
    ""
  );
